...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" style="height:630px;overflow-x:auto;border: solid; border-color: #DDDDDD;">
    ...
    <input id="type" type="hidden" value="${type}" >  <!-- 是团队还是旅客 -->
...
//        dataType:"json",                                       // json 数据类型提交 
   ...
   function addfunction(){
     ...
     var teamId= document.getElementById("type").value;
     
     form1.action="${ctx}/Predetermine/add.do?id="+id+"&type="+type+"&roomIdShuZu="+roomIdShuZu;
     form1.submit();
   }
